        ...
        <form method="post" action="{{route('farm.update',$farm)}}">
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="form-floating">
                    <input type="name" class="form-control" id="floatingInputGrid" placeholder="farm name" name="name" value="{{$farm->name}}" required>
                ...
                <div class="col-md">
                    <div class="form-floating">
                    <input type="number" value="{{$farm->size}}" class="form-control" id="floatingInputGrid"  name="size" placeholder="farm-size" required>
            ...
            <div class="form-floating mb-3">
                <input type="name" value="{{$farm->location}}" class="form-control" id="floatingInputGrid" placeholder="farm name" name="location" required>
                <label for="floatingInputGrid">Farm Location</label>
            </div>

            <div class="form-floating mb-3">
                <textarea class="form-control" name="description" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 150px"> {{$farm->description}}</textarea>

    ...
    <div class="content-wrapper" style=" margin-left: 0px !important;">
                  ...
                  <div class="card-body">
                    <div>
                      ...
                      <div class="btn-group w-100 mb-2">
                        ...
                        <a class="btn btn-info btn-filter active" href="javascript:void(0)" data-filter="all"> All items </a>
                         @php
                        ...
                        @foreach($farm_uploads as $farm_upload)
                          ...
                          @endphp
                          <a class="btn btn-info btn-filter" href="javascript:void(0)" data-filter="{{ $category->id }}"> {{ $category->name }} </a>
                        @endforeach
     ...
     <div class="modal fade" id="farmAssetss">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Select Asset/Tools For Activities</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
                  ...
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="form-floating mb-3 mb-md-0">
                                <input required class="form-control" id="inputdate" type="text" placeholder="" name="quantity"  />
      ...
      <div class="modal fade" id="farmCrops">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Create a Farm crop</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
                  ...
                  <div class="row mb-3">
                      <div class="col-md-6">
                          <div class="form-floating mb-3 mb-md-0">
                              ...
                              <label for="inputdate">planted on</label>
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-floating mb-3 mb-md-0">
                              <input required class="form-control" id="inputDuration" type="date" placeholder="who harvested" name="harvest_by"/>
      ...
      <div class="modal fade" id="farmactivities">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Create Farm Activities</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">
                                ...
                                <label for="inputdate">Activiites Cost</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">
                                <input required class="form-control" id="inputDuration" type="text"  disabled   placeholder="" name=""/>
                                <label for="inputDuration">Farm Land Size</label>
                            </div>
                        </div>
                    </div>
                    
                     <input type="hidden" value="{{$farm->id}}" name="activiity_farm_id"/>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">
